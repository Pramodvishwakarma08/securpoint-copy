...
import '../screen/auth_and_onboard/login/login_with_email.dart';
...
class ApiClient {
 ...
 // static const String mainUrl = "http://192.168.1.25:4003/";
  ...
  Future<dynamic> postRequest(
    ...
    try {
      Response<dynamic> response =
          await dio.post(endPoint, data: body, options: options);
      return _processResponse(response);
    } on DioException catch (e) {
      Response<dynamic> response = createErrorEntity(e);
      return _processResponse(response);
  ...
  Future<dynamic> deleteRequest(
    ...
    try {
      Response<dynamic> response =
          await dio.delete(endPoint, data: body, options: options);
      return _processResponse(response);
    } on DioException catch (e) {
      Response<dynamic> response = createErrorEntity(e);
      return _processResponse(response);
  ...
  Future<dynamic> patchRequest(
    ...
    try {
      Response<dynamic> response =
          await dio.patch(endPoint, data: body, options: options);
      return _processResponse(response);
    } on DioException catch (e) {
      Response<dynamic> response = createErrorEntity(e);
      return _processResponse(response);
