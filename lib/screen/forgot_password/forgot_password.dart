...
import 'package:securepoint/screen/auth_and_onboard/signup_with_email/otp_screen.dart';
import '../auth_and_onboard/signup_with_email/signup_with_email_screen.dart';
...
class _ForgotPasswordScreenState extends State<ForgotPasswordScreen> {
  ...
  login() async {
    isLoading(true);
   bool islogin = await ApiRepository.forgotPassword(email: emailPhoneTC.text, password: passwordTC.text,isEmail: isEmail);
    isLoading(false);
    if(islogin){
      Get.to(()=>OtpScreen(number: emailPhoneTC.text, isnumber: !isEmail));
   }
  }
