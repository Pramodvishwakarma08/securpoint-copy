...
//   login() async {
//     isLoading(true);
//     bool islogin =await ApiRepository.loginWithNumberPassword(number: emailPhoneTC.text, password: passwordTC.text);
//     isLoading(false);
//     if(islogin){
...
//                     primaryTextfieldSg(hintText: 'Email/Phone', controller: emailPhoneTC),
//
...
//                             Text('  Remember me',
//                               style: TextStyle(fontFamily: 'Roboto',
//                                 color: Color(0xff9A9A9A),fontWeight: FontWeight.w400,fontSize:12.fSize,
//                               ),
//                             ),
//                           ],
//                         ),
...
//                                   fontSize:14.fSize,fontWeight: FontWeight.w400,color: Color(0xff9A9A9A)
//                               ),
//                               children: [
//                                 TextSpan(
//                                   text: ' Sign up',
//                                   style: TextStyle(fontFamily: 'Times New Roman',
//                                     fontSize: 14.fSize,fontWeight: FontWeight.w700,color:Color(0xFF32CD30),
//                                   ),)]),),
//                       ),
//                     ),
//
