  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text('Premium', style: TextStyle(fontFamily: 'Inter',
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Center(child: SvgPicture.asset('assets/icon/ic_security_24px.svg',height: 77.6.ah,width:58.6.aw,)),
                            ...
                            Column(
                              children: [
                                Container(
                                  ...
                                  child:Center(child: SvgPicture.asset('assets/icon/Vector (3).svg',height:20.ah,width: 20.aw,fit: BoxFit.fill,)),
                                ),
                                SizedBox(height: 10.ah,),
                                Text('In-app messaging/\n    contact owner',
                                  style: TextStyle(height: 1.ah,fontFamily: 'Roboto',
                                      color: Color(0xff000000),fontWeight: FontWeight.w400,fontSize: 13.fSize
                                  ),
                                ),
                              ],
                            ),
                            ...
                            Column(
                              ...
                              children: [
                                ...
                                Container(
                                  ...
                                  child: Center(
                                      child:
                                      SvgPicture.asset('assets/icon/Report asset.svg',height:20.ah,width: 20.aw,)
                                  ),
                            ...
                            Column(
                              children: [
                                Container(
                                  ...
                                  child:Center(child: SvgPicture.asset('assets/icon/Vector (4).svg',height:20.ah,width:20.aw,fit: BoxFit.fill,)),
                                ),
                                SizedBox(height: 10.ah,),
                                Text('Initiate chats/\n    contacts',
                                  style: TextStyle(height: 1.ah,fontFamily: 'Roboto',
                ...
                children: [
                  Text(' Choose subscription plan for',
                    style: TextStyle(fontFamily: 'Roboto',
                      color: Color(0xff000000),fontWeight: FontWeight.w500,fontSize:13.fSize,
                    ),
                  ),
                  SizedBox(height:10.ah),
                  Obx(
                    ...
                    Row(
                      ...
                      children: [
                        Expanded(
                          child: DropdownButtonHideUnderline(
                            child: DropdownButton2<Plan>(
                              ...
                              items: controller.premiumPlanModel.plans?.map((var item) {
                              ...
                              onChanged: (var value) {
                                setState(() {
                                  ...
                                  setState(() {
                                    controller.amount!.value =value!.amount.toString();
                        ...
                        //       hint: Text('1 Month',
                        //         style: TextStyle(fontFamily: 'Roboto',
                        //             color: Color(0xff000000),fontWeight: FontWeight.w600,fontSize:15.fSize
                        //         ),
                        //       ),
                        //       items: _options
