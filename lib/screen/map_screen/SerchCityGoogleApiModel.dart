...
class SerchCityGoogleApiModel {
    List<Prediction>? predictions;
    String? status;

    SerchCityGoogleApiModel({
        this.predictions,
        this.status,
    });

    factory SerchCityGoogleApiModel.fromRawJson(String str) => SerchCityGoogleApiModel.fromJson(json.decode(str));

    String toRawJson() => json.encode(toJson());

    factory SerchCityGoogleApiModel.fromJson(Map<String, dynamic> json) => SerchCityGoogleApiModel(
